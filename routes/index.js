...
exports = module.exports = function (app) {
	...
	app.get('/api/v1/lines/:slug', keystone.middleware.api, routes.api.lines.get);	
	app.get('/api/v1/collection/:slug', keystone.middleware.api, routes.api.collections.get);	
